...
#define T_SHT MT(MOD_LSFT, KC_T)

// RIGHT HAND COLEMAK HOME ROW MODS ├───────────────────────────────────┐

#define N_SHT MT(MOD_RSFT, KC_N)
#define E_CTL MT(MOD_RCTL, KC_E)
#define I_ALT MT(MOD_RALT, KC_I)
#define O_CMD MT(MOD_RGUI, KC_O)

// LEFT HAND NUM HOME ROW MODS ├───────────────────────────────────┐

#define CIRC_CMD MT(MOD_LGUI, KC_CIRC) // Also used in SYM
#define P4_ALT MT(MOD_LALT, KC_P4)
#define P5_LCTL MT(MOD_LCTL, KC_P5)
#define P6_SHT MT(MOD_LSFT, KC_P6)

// RIGHT HAND NUM HOME ROW MODS ├───────────────────────────────────┐

#define P4_SHT MT(MOD_RSFT, KC_P4)
#define P5_RCTL MT(MOD_RCTL, KC_P5)
#define P6_ALT MT(MOD_RALT, KC_P6)
#define DLR_CMD MT(MOD_RGUI, KC_DLR) // Also used in SYM

// LEFT HAND SYM HOME ROW MODS ├───────────────────────────────────┐

#define MINS_ALT MT(MOD_LALT, KC_MINS)
#define PLUS_CTL MT(MOD_LCTL, KC_PPLS)
#define EQL_SHT MT(MOD_LSFT, KC_EQL)

// RIGHT HAND SYM HOME ROW MODS ├───────────────────────────────────┐

#define LBRC_SHT MT(MOD_RSFT, KC_LBRC)
#define RBRC_CTL MT(MOD_RCTL, KC_RBRC)
#define AT_ALT MT(MOD_RALT, KC_AT)

#define SPC_UP    LAG(KC_UP)         // Cycle through upper positions
#define SPC_DOWN  LAG(KC_DOWN)       // Cycle through lower positions
#define SPC_LEFT  LAG(KC_LEFT)       // Cycle through left positions
#define SPC_RIGHT LAG(KC_RGHT)       // Cycle through right positions
#define SPC_FULL  LAG(KC_F)          // Fullscreen
#define SPC_MVR   LCAG(KC_RIGHT)     // Move right one screen
#define SPC_MVL   LCAG(KC_LEFT)      // Move left one screen
#define SPC_UNDO  LCAG(KC_Z)         // Undo last spectacle action
...
/*
   ...
   │    ?    │    A    │    R    │    S    │    T    │    G    ├─╯                ╰─┤    M    │    N    │    E    │    I    │    O    │    ?    │
   ├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤╭────────╮╭────────╮├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤
   │   ESC   │    Z    │    X    │    C    │    D    │    V    ││   ?    ││PLY/PSE ││    K    │    H    │    ,    │    .    │    /    │   TAB   │
   └─────────┴─────────┴─────────┼─────────┼─────────┼─────────┼╰────────╯╰────────╯┼─────────┼─────────┼─────────┼─────────┴─────────┴─────────┘
                                 │ NUML_MS │ ENT_NUM │ SPC_NAV │    ?    ││    ?    │ DEL_SYM │  SHIFT  │ SHCAT_FN│
                                 └─────────┴─────────┴─────────┴─────────┘└─────────┴─────────┴─────────┴─────────┘ */

   [_COLEMAK] = LAYOUT_polydactyl(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
              KC_Q,     KC_W,     KC_F,     KC_P,     KC_B,                          KC_J,     KC_L,     KC_U,     KC_Y,     KC_QUOT,
    _______, A_CMD,    R_ALT,    S_CTL,    T_SHT,     KC_G,                          KC_M,     N_SHT,    E_CTL,    I_ALT,    O_CMD,    _______,
    _______,  KC_Z,     KC_X,     KC_C,     KC_D,     KC_V,     _______,   KC_MPLY,  KC_K,     KC_H,     KC_COMM,  KC_DOT,   KC_SLSH,  _______,
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
              KC_P0,    KC_P7,    KC_P8,    KC_P9,   _______,                       _______,  KC_P7,    KC_P8,    KC_P9,    KC_P0,
    _______,  CIRC_CMD, P4_ALT,   P5_LCTL,  P6_SHT,  KC_PERC,                       _______,  P4_SHT,   P5_RCTL,  P6_ALT,   DLR_CMD,  _______,
    _______,  KC_BSLS,  KC_P1,    KC_P2,    KC_P3,   _______,  _______,   _______,  _______,  KC_P1,    KC_P2,    KC_P3,    _______,  _______,
 ...
 /*
   ...
   [_NUM] = LAYOUT_polydactyl(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
              KC_HASH,  KC_LT,    KC_GT,    KC_EXLM, KC_SCLN,                       KC_QUES,  KC_LCBR,  KC_RCBR,  KC_GRV,   KC_DQT,
    _______,  CIRC_CMD, MINS_ALT, PLUS_CTL, EQL_SHT, KC_PERC,                       _______,  LBRC_SHT, RBRC_CTL, AT_ALT,   DLR_CMD,  _______,
    _______,  KC_BSLS,  KC_ASTR,  KC_PIPE,  KC_AMPR, KC_TILD,  _______,   _______,  _______,  KC_LPRN,  KC_RPRN,  KC_DOT,    _______,  _______,
                                  _______,  _______, _______,  _______,   _______,  _______,  _______,  _______
 ),
 /*
   ╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╸
   ...
   └───────────────────────────────────────────────────────────┘
             ┌─────────┬─────────┬─────────┬─────────┬─────────┐                    ┌─────────┬─────────┬─────────┬─────────┬─────────┐
             │SPEC_UNDO│SPEC_LEFT│ SPEC_UP │SPEC_DOWN│SPEC_RHGT│ ╭╮╭╮╭╮╭╮╭╮╭╮╭╮╭╮╭╮ │         │    F7   │    F8   │    F9   │   F10   │
   ┌─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤ │╰╯╰╯╰╯╰╯╰╯╰╯╰╯╰╯│ ├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┐
   │         │         │  size-  │  size+  │SPEC_FULL│SPEC_MOVE├─╯                ╰─┤         │    F4   │    F5   │    F6   │   F11   │         │
   ├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤╭────────╮╭────────╮├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤
   │         │         │         │         │         │         ││        ││        ││    .    │    F1   │    F2   │    F3   │   F12   │         │
   └─────────┴─────────┴─────────┼─────────┼─────────┼─────────┼╰────────╯╰────────╯┼─────────┼─────────┼─────────┼─────────┴─────────┴─────────┘
                                 │  LOCK   │BRHT_DOWN│ BRHT_UP │         ││         │         │         │         │
                                 └─────────┴─────────┴─────────┴─────────┘└─────────┴─────────┴─────────┴─────────┘ */

   [_NUM] = LAYOUT_polydactyl(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
              KC_HASH,  KC_LT,    KC_GT,    KC_EXLM,  KC_SCLN,                       _______,  KC_F7,    KC_F8,    KC_F9,    KC_F10,
    _______,  _______,  MINS_ALT, PLUS_CTL, EQL_SHT,  KC_PERC,                       _______,  KC_F4,    KC_F5,    KC_F6,    KC_F11,  _______,
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
              AU_TOGG,  XXXXXXX,  RGB_HUI,  RGB_MOD,  XXXXXXX,                       XXXXXXX,  KC_F7,    KC_F8,    KC_F9,    KC_F14,
...
// └───────────────────────────────────────────────────────────┘
        ...
        case MAKE_H:
          if (record->event.pressed) {
            SEND_STRING ("qmk compile -kb klor/2040 -km cosmicbuffalo");
            tap_code(KC_ENTER);
          }
          break;
